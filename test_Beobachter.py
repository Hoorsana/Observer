...
def test_experiment():
    ...
    for p in ps:
        ...
        # TODO Alpha
        result = report.results["Beobachter.x_hat(t)*K"]
        ...
        for i in V2:
            time2 = alpha_T.index(i)
            Zero_Estimation_X.append(time2)
            # TODO Geschwindigkeit
